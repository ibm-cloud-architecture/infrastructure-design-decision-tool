...
Refer to [Design Decision Tool Usage](usage.md) for an introduction and example of iusing the following design component categories that link to the Considerations and Caveats for the primary options available within each category:
